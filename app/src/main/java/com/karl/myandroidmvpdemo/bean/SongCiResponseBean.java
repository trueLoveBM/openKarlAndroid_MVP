package com.karl.myandroidmvpdemo.bean;

import java.util.List;

public class SongCiResponseBean {
    ...
    private List<SongCiBean> result;
    ...
    public List<SongCiBean> getResult() {
        return result;
    }

    public void setResult(List<SongCiBean> result) {
        this.result = result;
    }
