...
import com.karl.openkarlandroid_mvp.utils.NetWorkUtil;
...
public class BaseApi {
    ...
    public Retrofit getRetrofit(String baseUrl) {
        ...
        //缓存
        File cacheFile = new File(MVPModule.getInstance().getContext().getCacheDir(), "cache");
    ...
    private final Interceptor mRewriteCacheControlInterceptor = new Interceptor() {
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            if (!NetWorkUtil.isNetConnected(MVPModule.getInstance().getContext())) {//断网时配置缓存策略
...
//                        .cacheControl(CacheControl.FORCE_CACHE)
            ...
            if (NetWorkUtil.isNetConnected(MVPModule.getInstance().getContext())) {//在线缓存
//                KLog.e("在线缓存2分钟");
