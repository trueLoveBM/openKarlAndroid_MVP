...
public class ProgressObserver<T> implements Observer<T>, ProgressCancelListener {
    ...
    public ProgressObserver(Context context, String msg, ObserverResponseListener listener, boolean isDialog, boolean cancelable) {
        this.listener = listener;
        this.context = context;
        if (isDialog) {
            mProgressDialogHandler = new ProgressDialogHandler(context, msg, this, cancelable);
        }
    }
